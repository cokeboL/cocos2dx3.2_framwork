...
//////////////////////////////////////////////////////////////////////////
//	
void CMD5::UpDate(const TYBYTE* input, TYUINT length) 
{
...
//////////////////////////////////////////////////////////////////////////
//
void CMD5::Transform(const TYBYTE block[64])
{
	TYUINT a = m_state[0];
	TYUINT b = m_state[1];
	TYUINT c = m_state[2];
...
//////////////////////////////////////////////////////////////////////////
//	
void CMD5::DeCode(const TYBYTE* input, TYUINT* output, TYUINT length)
{
...
//////////////////////////////////////////////////////////////////////////
//
void CMD5::EnCode(const TYUINT* input, TYBYTE* output, TYUINT length)
{
...
//////////////////////////////////////////////////////////////////////////
//	计算 MD5 值
void CMD5::SetMD5Code(const TYBYTE* input, TYUINT length)
{
	int t, a, b;
...
//////////////////////////////////////////////////////////////////////////
//	获取文件的 MD5 值
char* CMD5::GetFileMD5Values(const char* pFileName)
{
	Init();
...
//////////////////////////////////////////////////////////////////////////
//	获取字符串的 MD5 值
char* CMD5::GetStringMD5Values(const char* pStr)
{
	Init();
